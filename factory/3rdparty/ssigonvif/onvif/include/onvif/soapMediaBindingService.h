...
public:
  ...
  virtual int
  GetServiceCapabilities(_trt__GetServiceCapabilities* trt__GetServiceCapabilities,
                         _trt__GetServiceCapabilitiesResponse* trt__GetServiceCapabilitiesResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetVideoSources(_trt__GetVideoSources* trt__GetVideoSources,
                              _trt__GetVideoSourcesResponse* trt__GetVideoSourcesResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetAudioSources(_trt__GetAudioSources* trt__GetAudioSources,
                              _trt__GetAudioSourcesResponse* trt__GetAudioSourcesResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetAudioOutputs(_trt__GetAudioOutputs* trt__GetAudioOutputs,
                              _trt__GetAudioOutputsResponse* trt__GetAudioOutputsResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int CreateProfile(_trt__CreateProfile* trt__CreateProfile,
                            _trt__CreateProfileResponse* trt__CreateProfileResponse) SOAP_PURE_VIRTUAL;

  /// Web service operation 'GetProfile' (returns error code or SOAP_OK)
  virtual int GetProfile(_trt__GetProfile* trt__GetProfile,
                         _trt__GetProfileResponse* trt__GetProfileResponse) SOAP_PURE_VIRTUAL;

  /// Web service operation 'GetProfiles' (returns error code or SOAP_OK)
  virtual int GetProfiles(_trt__GetProfiles* trt__GetProfiles,
                          _trt__GetProfilesResponse* trt__GetProfilesResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int AddVideoEncoderConfiguration(
      ...
      _trt__AddVideoEncoderConfigurationResponse* trt__AddVideoEncoderConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int AddVideoSourceConfiguration(
      ...
      _trt__AddVideoSourceConfigurationResponse* trt__AddVideoSourceConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int AddAudioEncoderConfiguration(
      ...
      _trt__AddAudioEncoderConfigurationResponse* trt__AddAudioEncoderConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int AddAudioSourceConfiguration(
      ...
      _trt__AddAudioSourceConfigurationResponse* trt__AddAudioSourceConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int AddPTZConfiguration(_trt__AddPTZConfiguration* trt__AddPTZConfiguration,
                                  _trt__AddPTZConfigurationResponse* trt__AddPTZConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int AddVideoAnalyticsConfiguration(
      ...
      _trt__AddVideoAnalyticsConfigurationResponse* trt__AddVideoAnalyticsConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int AddAudioOutputConfiguration(
      ...
      _trt__AddAudioOutputConfigurationResponse* trt__AddAudioOutputConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int RemoveVideoEncoderConfiguration(
      ...
      _trt__RemoveVideoEncoderConfigurationResponse* trt__RemoveVideoEncoderConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int RemoveVideoSourceConfiguration(
      ...
      _trt__RemoveVideoSourceConfigurationResponse* trt__RemoveVideoSourceConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int RemoveAudioEncoderConfiguration(
      ...
      _trt__RemoveAudioEncoderConfigurationResponse* trt__RemoveAudioEncoderConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int RemoveAudioSourceConfiguration(
      ...
      _trt__RemoveAudioSourceConfigurationResponse* trt__RemoveAudioSourceConfigurationResponse) SOAP_PURE_VIRTUAL;

  /// Web service operation 'RemovePTZConfiguration' (returns error code or SOAP_OK)
  virtual int
  RemovePTZConfiguration(_trt__RemovePTZConfiguration* trt__RemovePTZConfiguration,
                         _trt__RemovePTZConfigurationResponse* trt__RemovePTZConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int RemoveVideoAnalyticsConfiguration(
      ...
      _trt__RemoveVideoAnalyticsConfigurationResponse* trt__RemoveVideoAnalyticsConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int RemoveMetadataConfiguration(
      ...
      _trt__RemoveMetadataConfigurationResponse* trt__RemoveMetadataConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int RemoveAudioOutputConfiguration(
      ...
      _trt__RemoveAudioOutputConfigurationResponse* trt__RemoveAudioOutputConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int RemoveAudioDecoderConfiguration(
      ...
      _trt__RemoveAudioDecoderConfigurationResponse* trt__RemoveAudioDecoderConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int DeleteProfile(_trt__DeleteProfile* trt__DeleteProfile,
                            _trt__DeleteProfileResponse* trt__DeleteProfileResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetVideoSourceConfigurations(
      ...
      _trt__GetVideoSourceConfigurationsResponse* trt__GetVideoSourceConfigurationsResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetVideoEncoderConfigurations(
      ...
      _trt__GetVideoEncoderConfigurationsResponse* trt__GetVideoEncoderConfigurationsResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetAudioSourceConfigurations(
      ...
      _trt__GetAudioSourceConfigurationsResponse* trt__GetAudioSourceConfigurationsResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetAudioEncoderConfigurations(
      ...
      _trt__GetAudioEncoderConfigurationsResponse* trt__GetAudioEncoderConfigurationsResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetVideoAnalyticsConfigurations(
      ...
      _trt__GetVideoAnalyticsConfigurationsResponse* trt__GetVideoAnalyticsConfigurationsResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetAudioOutputConfigurations(
      ...
      _trt__GetAudioOutputConfigurationsResponse* trt__GetAudioOutputConfigurationsResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetAudioDecoderConfigurations(
      ...
      _trt__GetAudioDecoderConfigurationsResponse* trt__GetAudioDecoderConfigurationsResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetVideoSourceConfiguration(
      ...
      _trt__GetVideoSourceConfigurationResponse* trt__GetVideoSourceConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetVideoEncoderConfiguration(
      ...
      _trt__GetVideoEncoderConfigurationResponse* trt__GetVideoEncoderConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetAudioSourceConfiguration(
      ...
      _trt__GetAudioSourceConfigurationResponse* trt__GetAudioSourceConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetAudioEncoderConfiguration(
      ...
      _trt__GetAudioEncoderConfigurationResponse* trt__GetAudioEncoderConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetVideoAnalyticsConfiguration(
      ...
      _trt__GetVideoAnalyticsConfigurationResponse* trt__GetVideoAnalyticsConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetAudioOutputConfiguration(
      ...
      _trt__GetAudioOutputConfigurationResponse* trt__GetAudioOutputConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetAudioDecoderConfiguration(
      ...
      _trt__GetAudioDecoderConfigurationResponse* trt__GetAudioDecoderConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int SetVideoSourceConfiguration(
      ...
      _trt__SetVideoSourceConfigurationResponse* trt__SetVideoSourceConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int SetAudioSourceConfiguration(
      ...
      _trt__SetAudioSourceConfigurationResponse* trt__SetAudioSourceConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int SetAudioEncoderConfiguration(
      ...
      _trt__SetAudioEncoderConfigurationResponse* trt__SetAudioEncoderConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int SetVideoAnalyticsConfiguration(
      ...
      _trt__SetVideoAnalyticsConfigurationResponse* trt__SetVideoAnalyticsConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int SetAudioOutputConfiguration(
      ...
      _trt__SetAudioOutputConfigurationResponse* trt__SetAudioOutputConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int SetAudioDecoderConfiguration(
      ...
      _trt__SetAudioDecoderConfigurationResponse* trt__SetAudioDecoderConfigurationResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetMetadataConfigurationOptions(
      ...
      _trt__GetMetadataConfigurationOptionsResponse* trt__GetMetadataConfigurationOptionsResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetStreamUri(_trt__GetStreamUri* trt__GetStreamUri,
                           _trt__GetStreamUriResponse* trt__GetStreamUriResponse) SOAP_PURE_VIRTUAL;

  /// Web service operation 'StartMulticastStreaming' (returns error code or SOAP_OK)
  virtual int
  StartMulticastStreaming(_trt__StartMulticastStreaming* trt__StartMulticastStreaming,
                          _trt__StartMulticastStreamingResponse* trt__StartMulticastStreamingResponse) SOAP_PURE_VIRTUAL;

  /// Web service operation 'StopMulticastStreaming' (returns error code or SOAP_OK)
  virtual int
  StopMulticastStreaming(_trt__StopMulticastStreaming* trt__StopMulticastStreaming,
                         _trt__StopMulticastStreamingResponse* trt__StopMulticastStreamingResponse) SOAP_PURE_VIRTUAL;

  /// Web service operation 'SetSynchronizationPoint' (returns error code or SOAP_OK)
  virtual int
  SetSynchronizationPoint(_trt__SetSynchronizationPoint* trt__SetSynchronizationPoint,
                          _trt__SetSynchronizationPointResponse* trt__SetSynchronizationPointResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetSnapshotUri(_trt__GetSnapshotUri* trt__GetSnapshotUri,
                             _trt__GetSnapshotUriResponse* trt__GetSnapshotUriResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetVideoSourceModes(_trt__GetVideoSourceModes* trt__GetVideoSourceModes,
                                  _trt__GetVideoSourceModesResponse* trt__GetVideoSourceModesResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int SetVideoSourceMode(_trt__SetVideoSourceMode* trt__SetVideoSourceMode,
                                 _trt__SetVideoSourceModeResponse* trt__SetVideoSourceModeResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int GetOSDOptions(_trt__GetOSDOptions* trt__GetOSDOptions,
                            _trt__GetOSDOptionsResponse* trt__GetOSDOptionsResponse) SOAP_PURE_VIRTUAL;
  ...
  virtual int CreateOSD(_trt__CreateOSD* trt__CreateOSD,
                        _trt__CreateOSDResponse* trt__CreateOSDResponse) SOAP_PURE_VIRTUAL;

  /// Web service operation 'DeleteOSD' (returns error code or SOAP_OK)
  virtual int DeleteOSD(_trt__DeleteOSD* trt__DeleteOSD,
                        _trt__DeleteOSDResponse* trt__DeleteOSDResponse) SOAP_PURE_VIRTUAL;
};
#endif
