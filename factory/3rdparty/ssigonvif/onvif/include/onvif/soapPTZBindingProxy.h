...
public:
  ...
  virtual int GetServiceCapabilities(_tptz__GetServiceCapabilities* tptz__GetServiceCapabilities,
  ...
  virtual int GetConfigurations(_tptz__GetConfigurations* tptz__GetConfigurations,
  ...
  virtual int GetConfigurations(const char* endpoint, const char* soap_action,
  ...
  virtual int GetPresets(const char* endpoint, const char* soap_action, _tptz__GetPresets* tptz__GetPresets,
  ...
  virtual int SetPreset(const char* endpoint, const char* soap_action, _tptz__SetPreset* tptz__SetPreset,
                        _tptz__SetPresetResponse* tptz__SetPresetResponse);

  /// Web service operation 'RemovePreset' (returns error code or SOAP_OK)
  virtual int RemovePreset(_tptz__RemovePreset* tptz__RemovePreset,
  ...
  virtual int RemovePreset(const char* endpoint, const char* soap_action, _tptz__RemovePreset* tptz__RemovePreset,
                           _tptz__RemovePresetResponse* tptz__RemovePresetResponse);
  ...
  virtual int GotoPreset(const char* endpoint, const char* soap_action, _tptz__GotoPreset* tptz__GotoPreset,
  ...
  virtual int GetStatus(const char* endpoint, const char* soap_action, _tptz__GetStatus* tptz__GetStatus,
                        _tptz__GetStatusResponse* tptz__GetStatusResponse);

  /// Web service operation 'GetConfiguration' (returns error code or SOAP_OK)
  virtual int GetConfiguration(_tptz__GetConfiguration* tptz__GetConfiguration,
  ...
  virtual int GetConfiguration(const char* endpoint, const char* soap_action,
  ...
  virtual int GetNodes(const char* endpoint, const char* soap_action, _tptz__GetNodes* tptz__GetNodes,
  ...
  virtual int GetNode(const char* endpoint, const char* soap_action, _tptz__GetNode* tptz__GetNode,
                      _tptz__GetNodeResponse* tptz__GetNodeResponse);

  /// Web service operation 'SetConfiguration' (returns error code or SOAP_OK)
  virtual int SetConfiguration(_tptz__SetConfiguration* tptz__SetConfiguration,
  ...
  virtual int SetConfiguration(const char* endpoint, const char* soap_action,
  ...
  virtual int GetConfigurationOptions(_tptz__GetConfigurationOptions* tptz__GetConfigurationOptions,
                                      _tptz__GetConfigurationOptionsResponse* tptz__GetConfigurationOptionsResponse)
  {
    return this->GetConfigurationOptions(NULL, NULL, tptz__GetConfigurationOptions,
                                         tptz__GetConfigurationOptionsResponse);
  }
  virtual int GetConfigurationOptions(const char* endpoint, const char* soap_action,
  ...
  virtual int GotoHomePosition(_tptz__GotoHomePosition* tptz__GotoHomePosition,
  ...
  virtual int GotoHomePosition(const char* endpoint, const char* soap_action,
                               _tptz__GotoHomePosition* tptz__GotoHomePosition,
                               _tptz__GotoHomePositionResponse* tptz__GotoHomePositionResponse);

  /// Web service operation 'SetHomePosition' (returns error code or SOAP_OK)
  virtual int SetHomePosition(_tptz__SetHomePosition* tptz__SetHomePosition,
  ...
  virtual int SetHomePosition(const char* endpoint, const char* soap_action,
                              _tptz__SetHomePosition* tptz__SetHomePosition,
                              _tptz__SetHomePositionResponse* tptz__SetHomePositionResponse);

  /// Web service operation 'ContinuousMove' (returns error code or SOAP_OK)
  virtual int ContinuousMove(_tptz__ContinuousMove* tptz__ContinuousMove,
  ...
  virtual int ContinuousMove(const char* endpoint, const char* soap_action, _tptz__ContinuousMove* tptz__ContinuousMove,
                             _tptz__ContinuousMoveResponse* tptz__ContinuousMoveResponse);

  /// Web service operation 'RelativeMove' (returns error code or SOAP_OK)
  virtual int RelativeMove(_tptz__RelativeMove* tptz__RelativeMove,
  ...
  virtual int RelativeMove(const char* endpoint, const char* soap_action, _tptz__RelativeMove* tptz__RelativeMove,
                           _tptz__RelativeMoveResponse* tptz__RelativeMoveResponse);

  /// Web service operation 'SendAuxiliaryCommand' (returns error code or SOAP_OK)
  virtual int SendAuxiliaryCommand(_tptz__SendAuxiliaryCommand* tptz__SendAuxiliaryCommand,
  ...
  virtual int AbsoluteMove(_tptz__AbsoluteMove* tptz__AbsoluteMove,
  ...
  virtual int AbsoluteMove(const char* endpoint, const char* soap_action, _tptz__AbsoluteMove* tptz__AbsoluteMove,
                           _tptz__AbsoluteMoveResponse* tptz__AbsoluteMoveResponse);
  ...
  virtual int Stop(const char* endpoint, const char* soap_action, _tptz__Stop* tptz__Stop,
                   _tptz__StopResponse* tptz__StopResponse);

  /// Web service operation 'GetPresetTours' (returns error code or SOAP_OK)
  virtual int GetPresetTours(_tptz__GetPresetTours* tptz__GetPresetTours,
  ...
  virtual int GetPresetTours(const char* endpoint, const char* soap_action, _tptz__GetPresetTours* tptz__GetPresetTours,
                             _tptz__GetPresetToursResponse* tptz__GetPresetToursResponse);

  /// Web service operation 'GetPresetTour' (returns error code or SOAP_OK)
  virtual int GetPresetTour(_tptz__GetPresetTour* tptz__GetPresetTour,
  ...
  virtual int GetPresetTour(const char* endpoint, const char* soap_action, _tptz__GetPresetTour* tptz__GetPresetTour,
                            _tptz__GetPresetTourResponse* tptz__GetPresetTourResponse);

  /// Web service operation 'GetPresetTourOptions' (returns error code or SOAP_OK)
  virtual int GetPresetTourOptions(_tptz__GetPresetTourOptions* tptz__GetPresetTourOptions,
  ...
  virtual int GetPresetTourOptions(const char* endpoint, const char* soap_action,
  ...
  virtual int CreatePresetTour(_tptz__CreatePresetTour* tptz__CreatePresetTour,
  ...
  virtual int CreatePresetTour(const char* endpoint, const char* soap_action,
                               _tptz__CreatePresetTour* tptz__CreatePresetTour,
                               _tptz__CreatePresetTourResponse* tptz__CreatePresetTourResponse);

  /// Web service operation 'ModifyPresetTour' (returns error code or SOAP_OK)
  virtual int ModifyPresetTour(_tptz__ModifyPresetTour* tptz__ModifyPresetTour,
  ...
  virtual int ModifyPresetTour(const char* endpoint, const char* soap_action,
                               _tptz__ModifyPresetTour* tptz__ModifyPresetTour,
                               _tptz__ModifyPresetTourResponse* tptz__ModifyPresetTourResponse);

  /// Web service operation 'OperatePresetTour' (returns error code or SOAP_OK)
  virtual int OperatePresetTour(_tptz__OperatePresetTour* tptz__OperatePresetTour,
  ...
  virtual int OperatePresetTour(const char* endpoint, const char* soap_action,
                                _tptz__OperatePresetTour* tptz__OperatePresetTour,
                                _tptz__OperatePresetTourResponse* tptz__OperatePresetTourResponse);

  /// Web service operation 'RemovePresetTour' (returns error code or SOAP_OK)
  virtual int RemovePresetTour(_tptz__RemovePresetTour* tptz__RemovePresetTour,
  ...
  virtual int RemovePresetTour(const char* endpoint, const char* soap_action,
  ...
  virtual int
  GetCompatibleConfigurations(_tptz__GetCompatibleConfigurations* tptz__GetCompatibleConfigurations,
                              _tptz__GetCompatibleConfigurationsResponse* tptz__GetCompatibleConfigurationsResponse)
  {
    return this->GetCompatibleConfigurations(NULL, NULL, tptz__GetCompatibleConfigurations,
                                             tptz__GetCompatibleConfigurationsResponse);
  }
  virtual int
  GetCompatibleConfigurations(const char* endpoint, const char* soap_action,
