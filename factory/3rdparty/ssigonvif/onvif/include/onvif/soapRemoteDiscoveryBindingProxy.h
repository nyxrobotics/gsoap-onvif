...
public:
  ...
  virtual int Hello(struct wsdd__HelloType tdn__Hello, struct wsdd__ResolveType& tdn__HelloResponse)
  {
    return this->Hello(NULL, NULL, tdn__Hello, tdn__HelloResponse);
  }
  virtual int Hello(const char* endpoint, const char* soap_action, struct wsdd__HelloType tdn__Hello,
                    struct wsdd__ResolveType& tdn__HelloResponse);

  /// Web service operation 'Bye' (returns error code or SOAP_OK)
  virtual int Bye(struct wsdd__ByeType tdn__Bye, struct wsdd__ResolveType& tdn__ByeResponse)
  {
    return this->Bye(NULL, NULL, tdn__Bye, tdn__ByeResponse);
  }
  virtual int Bye(const char* endpoint, const char* soap_action, struct wsdd__ByeType tdn__Bye,
  ...
  virtual int Probe(const char* endpoint, const char* soap_action, struct wsdd__ProbeType tdn__Probe,
