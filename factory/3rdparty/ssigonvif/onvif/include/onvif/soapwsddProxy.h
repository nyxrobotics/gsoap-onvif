...
public:
  ...
  virtual int Hello(const char* endpoint, const char* soap_action, struct wsdd__HelloType* wsdd__Hello)
  {
    if (this->send_Hello(endpoint, soap_action, wsdd__Hello) || soap_recv_empty_response(this->soap))
  ...
  virtual int Bye(const char* endpoint, const char* soap_action, struct wsdd__ByeType* wsdd__Bye)
  {
    if (this->send_Bye(endpoint, soap_action, wsdd__Bye) || soap_recv_empty_response(this->soap))
      return this->soap->error;
    return SOAP_OK;
  }
  ...
  virtual int Probe(const char* endpoint, const char* soap_action, struct wsdd__ProbeType* wsdd__Probe)
  {
    if (this->send_Probe(endpoint, soap_action, wsdd__Probe) || soap_recv_empty_response(this->soap))
      return this->soap->error;
    return SOAP_OK;
  }
  ...
  virtual int send_ProbeMatches(const char* endpoint, const char* soap_action,
  ...
  virtual int ProbeMatches(const char* endpoint, const char* soap_action,
                           struct wsdd__ProbeMatchesType* wsdd__ProbeMatches)
  {
    if (this->send_ProbeMatches(endpoint, soap_action, wsdd__ProbeMatches) || soap_recv_empty_response(this->soap))
      return this->soap->error;
    return SOAP_OK;
  }
  ...
  virtual int Resolve(const char* endpoint, const char* soap_action, struct wsdd__ResolveType* wsdd__Resolve)
  {
    if (this->send_Resolve(endpoint, soap_action, wsdd__Resolve) || soap_recv_empty_response(this->soap))
      return this->soap->error;
    return SOAP_OK;
  }
  ...
  virtual int send_ResolveMatches(const char* endpoint, const char* soap_action,
  ...
  virtual int ResolveMatches(const char* endpoint, const char* soap_action,
                             struct wsdd__ResolveMatchesType* wsdd__ResolveMatches)
  {
    if (this->send_ResolveMatches(endpoint, soap_action, wsdd__ResolveMatches) || soap_recv_empty_response(this->soap))
      return this->soap->error;
    return SOAP_OK;
  }
};
