...
{ return soap_wsse_add_UsernameTokenDigestOffset(soap, id, username, password, 0);
} 

/**
@fn int soap_wsse_add_UsernameTokenDigestOffset(struct soap *soap, const char *id, const char *username, const char *password, long offset)
@brief Adds UsernameToken element for digest authentication.
@param soap context
@param[in] id string for signature referencing or NULL
@param[in] username string
...
*/
int
soap_wsse_add_UsernameTokenDigestOffset(struct soap *soap, const char *id, const char *username, const char *password, long offset)
{ _wsse__Security *security = soap_wsse_add_Security(soap);
...
{ calc_nonce_offset(soap, nonce, 0);
}
...
*/
static void
calc_nonce_offset(struct soap *soap, char nonce[SOAP_WSSE_NONCELEN], long offset)
{ int i;
