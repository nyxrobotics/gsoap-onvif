...
if("${CMAKE_CXX_COMPILER_ID}"
  ...
  if(TEMP_COMPILER_VERSION
     VERSION_LESS
     4.7
  )
    message(
      FATAL_ERROR "${PROJECT_NAME_STR} requires g++ 4.7 or greater. Installed version: ${CMAKE_CXX_COMPILER_VERSION}"
    )
  endif()
elseif(
  ...
  if(TEMP_COMPILER_VERSION
    ...
    message(
      FATAL_ERROR "${PROJECT_NAME_STR} requires Clang 3.4 or greater. Installed version: ${CMAKE_CXX_COMPILER_VERSION}"
    )
  endif()
elseif(
  "${CMAKE_CXX_COMPILER_ID}"
  ...
  if(CMAKE_CXX_COMPILER_VERSION
    ...
    message(
      FATAL_ERROR
        "${PROJECT_NAME_STR} requires MSVC 1700 (MSVC 2012) or greater. Installed version: ${CMAKE_CXX_COMPILER_VERSION}"
    )
  endif()
else()
  message(
    WARNING "You are using an unsupported compiler! ${PROJECT_NAME_STR} has only been tested with Clang, GCC and MSVC."
  )
endif()
