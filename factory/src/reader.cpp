...
OpenCVVideoReader::OpenCVVideoReader(const std::string uri) : counter_(0)
{
  cap_.open(uri);
...
OpenCVImageReader::OpenCVImageReader(const std::vector<std::string>& img_lst) : img_lst_(img_lst), counter_(0)
{
}
